...
#define UartPackageLengthToHost     64      /* Nios to Host data package length */
...
//     unsigned int uiHostCmdTimeUnit;
     ...
     char     cFlagPackDataToHost; /* flag, 1:pack data send to host */
     char     cFlagUnpackHostComplete; /* flag, 1: unpack host data complete */
     unsigned char cFlagHostDataIn;    /* 1: indicated Host Data In */
     ...
     unsigned int uiRecvHostPackageTimeCnt;  /*Receive Host package Counter */

     /* LED status */
     unsigned char ucLedError;          /* Error message led */
     unsigned char ucLedRcvHostPackage; /* Receive Host package data led */
     unsigned char ucLedNiosLife;       /* Nios life Led */
     unsigned char ucLedStatus;         /* output to Status led value*/
}sNios_s;
    ...
    /* 宣告以下函數為 extern */
            ...
            extern void UartTxbufProcess( sNios_s *sNios);
            extern void UartRxbufProcess( sNios_s *sNios);
            extern void SelfCircleRunTest(sNios_s *sNios);     /* Test motor & driver etc.*/
        ...
        /* motor function */
         ...
         /* Status Led function */
            extern void ShowStatusLed(sNios_s *sNios);     /* show status LED */
