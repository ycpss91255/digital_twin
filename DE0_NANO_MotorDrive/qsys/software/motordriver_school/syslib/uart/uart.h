...
typedef struct {
    ...
    unsigned char  ucRxBuf[BufLength];  /* Uart buffer */
             int   uiRxBuf_Head;  /* Uart Rx buffer Head index */
             int   uiRxBuf_End;   /* Uart Rx buffer end index */
    unsigned char  ucTxBuf[BufLength];  /* Uart Tx buffer */
             int   uiTxBuf_Head;  /* Uart Tx buffer Head index */
             int   uiTxBuf_End;   /* Uart Tx buffer end index  */
