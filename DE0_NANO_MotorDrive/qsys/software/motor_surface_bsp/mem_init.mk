...
# Memory: epcs_controlle
MEM_0 := sopc_epcs_controlle_boot_rom
$(MEM_0)_NAME := epcs_controlle
...
$(MEM_0)_HIERARCHICAL_PATH := epcs_controlle
$(MEM_0)_WIDTH := 32
...
.PHONY: epcs_controlle
epcs_controlle: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash
